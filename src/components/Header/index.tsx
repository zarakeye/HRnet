  ...
  return (
    <header className='w-full fixed flex flex-row flex-1 items-baseline justify-center bg-white py-[20px] pl-[20px] z-10'>
      <figure className='flex flex-col items-center justify-center bg-white p-[10px]'>
        <img src={logo} alt="WealthHealth Logo" className='h-28 w-[113.08px] cursor-pointer' onClick={() => navigate('/')} />
      ...
      <h1 className='text-[#105924] text-8xl inline-block p-[10px] cursor-pointer' onClick={() => navigate('/')}>
        HRnet
      </h1>
